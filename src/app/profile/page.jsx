                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {programmingLanguages.map((lang) => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-none text-sm transition-all duration-200 border-2 ${preferences.languages.includes(lang)
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-neutral-800 border-2 border-neutral-700 text-white rounded-none outline-none transition-all duration-200"
                    >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {interestTopics.map((topic) => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-none text-sm transition-all duration-200 border-2 ${preferences.topics.includes(topic)
                              ? 'bg-white text-black border-white font-medium'
                              : 'bg-neutral-800 text-neutral-300 border-neutral-700 hover:border-neutral-500 hover:text-white'
                            }`}
                        >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-black ${preferences.notifications.recommendations ? 'bg-white' : 'bg-neutral-700'
                        }`}
                    >
                      <span className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-black shadow ring-0 transition duration-200 ease-in-out ${preferences.notifications.recommendations ? 'translate-x-5' : 'translate-x-0'
                        }`}></span>
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <span className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-black shadow ring-0 transition duration-200 ease-in-out ${preferences.notifications.goodFirstIssues ? 'translate-x-5' : 'translate-x-0'
                        }`}></span>
                    </button>
                  </div>
                </div>
