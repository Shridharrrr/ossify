        ...
        <div className="p-6 lg:p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              ...
              {totalCount > 0 && ` (${totalCount.toLocaleString()} repositories found)`}
            </p>
          </div>
            ...
            <>
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                {repositories.map((repo) => (
                  <div key={repo.id} className="bg-white rounded-lg shadow-sm border p-6 hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <button className="text-gray-400 hover:text-blue-600 flex-shrink-0 ml-2">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs ${getDifficultyColor(repo.difficulty_level)}`}>
